---
title: "My Vim Setup for ASIC Design"
excerpt: "Custom keybinds, SystemVerilog LSP, waveform previews, and why I refuse to use an IDE."
category: tutorials
date: 2026-03-18
readTime: "6 min"
tags: ["Vim", "Workflow"]
...
This is where the full **My Vim Setup for ASIC Design** write-up will live. The terminal-inspired layout carries through with monospace typography, code-comment section headers, and the same dark palette as the rest of the site.
...
> **note:** this is a seeded placeholder post. Replace the body of `vim-asic.md` with the real article whenever you're ready — the frontmatter above already drives the card, the filters, and the SEO.
