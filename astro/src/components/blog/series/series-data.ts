...
export const BLOG_SERIES: Series[] = [
  {
    ...
    nextRunISO: '2026-06-22T08:00:00', runs: [3, 4, 2, 5, 4, 6, 5, 7], url: '/trackers/inference-engines.html',
    editions: [
  ...
  },
  {
    ...
    nextRunISO: '2026-06-17T08:00:00', runs: [2, 3, 4, 3, 5], url: '/trackers/frontier-models.html',
    editions: [
  ...
  },
  {
    ...
    nextRunISO: '2026-06-19T08:00:00', runs: [4, 3, 5, 4, 6], url: '/trackers/inference-silicon.html',
    editions: [
